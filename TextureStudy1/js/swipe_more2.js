var treeBark1Bt = new Audio('audio/Tree bark 1 bt.m4a');
var treeBark1Lr = new Audio('audio/Tree bark 1 lr.m4a');
var treeBark1Rl = new Audio('audio/Tree bark 1 rl.m4a');
var treeBark1Tb = new Audio('audio/Tree bark 1 tb.m4a');

var treeBark2Bt = new Audio('audio/Tree bark 2 bt.m4a');
var treeBark2Lr = new Audio('audio/Tree bark 2 lr.m4a');
var treeBark2Rl = new Audio('audio/Tree bark 2 rl.m4a');
var treeBark2Tb = new Audio('audio/Tree bark 2 tb.m4a');

var treeBark4Bt = new Audio('audio/Tree bark 4 bt.m4a');
var treeBark4Lr = new Audio('audio/Tree bark 4 lr.m4a');
var treeBark4Rl = new Audio('audio/Tree bark 4 rl.m4a');
var treeBark4Tb = new Audio('audio/Tree bark 4 tb.m4a');

var treeBark10Bt = new Audio('audio/Tree bark 10 bt.m4a');
var treeBark10Lr = new Audio('audio/Tree bark 10 lr.m4a');
var treeBark10Rl = new Audio('audio/Tree bark 10 rl.m4a');
var treeBark10Tb = new Audio('audio/Tree bark 10 tb.m4a');

var velvetBt = new Audio('audio/Velvet bt.m4a');
var velvetLr = new Audio('audio/Velvet lr.m4a');
var velvetRl = new Audio('audio/Velvet rl.m4a');
var velvetTb = new Audio('audio/Velvet tb.m4a');
...
function loadaudio(){
    treeBark1Bt = new Audio('audio/Tree bark 1 bt.m4a');
    treeBark1Lr = new Audio('audio/Tree bark 1 lr.m4a');
    treeBark1Rl = new Audio('audio/Tree bark 1 rl.m4a');
    treeBark1Tb = new Audio('audio/Tree bark 1 tb.m4a');
    
    treeBark2Bt = new Audio('audio/Tree bark 2 bt.m4a');
    treeBark2Lr = new Audio('audio/Tree bark 2 lr.m4a');
    treeBark2Rl = new Audio('audio/Tree bark 2 rl.m4a');
    treeBark2Tb = new Audio('audio/Tree bark 2 tb.m4a');
    
    treeBark4Bt = new Audio('audio/Tree bark 4 bt.m4a');
    treeBark4Lr = new Audio('audio/Tree bark 4 lr.m4a');
    treeBark4Rl = new Audio('audio/Tree bark 4 rl.m4a');
    treeBark4Tb = new Audio('audio/Tree bark 4 tb.m4a');
    
    treeBark10Bt = new Audio('audio/Tree bark 10 bt.m4a');
    treeBark10Lr = new Audio('audio/Tree bark 10 lr.m4a');
    treeBark10Rl = new Audio('audio/Tree bark 10 rl.m4a');
    treeBark10Tb = new Audio('audio/Tree bark 10 tb.m4a');
    
    velvetBt = new Audio('audio/Velvet bt.m4a');
    velvetLr = new Audio('audio/Velvet lr.m4a');
    velvetRl = new Audio('audio/Velvet rl.m4a');
    velvetTb = new Audio('audio/Velvet tb.m4a');
    treeBark1Bt.load();
    treeBark1Lr.load();
    treeBark1Rl.load();
    treeBark1Tb.load();
