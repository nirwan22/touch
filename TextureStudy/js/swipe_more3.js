...
var honeycomb = new Audio('audio/Scaly lr.m4a')
...
function loadaudio(){
    ...
    honeycomb = new Audio('audio/Scaly lr.m4a')
...
//Bark2
    ...
    // audiolrtb.loop = true;
    // audiolrtb.autoplay = true;

    // beehive.loop = true;
    // beehive.autoplay = true;

    // honeycomb.loop = true;
    // honeycomb.autoplay = true;
 ...
 //Bumblebee
    ...
    ontouch(el3, function(evt, dir, phase, swipetype, distance,pointertype){
      ...
      if (play==0 && phase=="move") {audiolrtb.play();play=1;};
    ...
    ontouch(el1, function(evt, dir, phase, swipetype, distance,pointertype){
      ...
      if (play==0 && phase=="move") {beehive.play();play=1;};
      if (play==1 && phase=="end") {beehive.pause();play=0;} ;
        var touchreport = '';
        touchreport += '<b>Pointer Type:</b> ' + pointertype + '; <b>Dir:</b> ' + dir + '; ';
        touchreport += '<b>Phase:</b> ' + phase + '; ';
        touchreport += '<b>Distance:</b> ' + distance + '<br />';
    ...
    ontouch(el5, function(evt, dir, phase, swipetype, distance,pointertype){
      ...
      if (play==0 && phase=="move") {honeycomb.play();play=1;};
      if (play==1 && phase=="end") {honeycomb.pause();play=0;} ;
        var touchreport = '';
        touchreport += '<b>Pointer Type:</b> ' + pointertype + '; <b>Dir:</b> ' + dir + '; ';
        touchreport += '<b>Phase:</b> ' + phase + '; ';
        touchreport += '<b>Distance:</b> ' + distance + '<br />';
